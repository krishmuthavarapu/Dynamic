	...
	if ($_GET["newpage"] || $_GET["editpage"]) {
		...
		if ($_GET["editpage"]) {
			...
			if (!empty($_POST["page_title"])) {
				$pageUpdate = "UPDATE pages SET title='".$_POST["page_title"]."',team1='".$_POST["team1"]."',team2='".$_POST["team2"]."',content='".$_POST["page_content"]."',thumbnail='".$_POST["page_image"]."',thumbnail1='".$_POST["page_image1"]."',active=".$_POST["page_status"].",datetime='".date("Y-m-d H:i:s")."' WHERE id='$thePageId'";
			...
			$sqlPages = mysqli_query($db_conn, "SELECT id, title, team1, team2, thumbnail, thumbnail1, content, active, datetime FROM pages WHERE id='$thePageId'");
		...
		//Create new page
			...
			if (!empty($_POST["page_title"])) {
				$pageInsert = "INSERT INTO pages (title, team1, team2, content, thumbnail, thumbnail1, active) VALUES ('".$_POST["page_title"]."', '".$_POST["team1"]."', '".$_POST["team1"]."', '".$_POST["page_content"]."', '".$_POST["page_image"]."', '".$_POST["page_image1"].", ".$_POST["page_status"].")";
    ...
    <?php
		...
		?>
			...
			<table class="table table-bordered table-hover table-striped">
				...
				<tbody>
        <?php
					$sqlPages = mysqli_query($db_conn, "SELECT id, title, team1, team2, thumbnail, thumbnail1, content, active FROM pages ORDER BY datetime DESC");
